...
$id = $_GET['id'];
$url = get_field('api_domain', 'options') . 'order/' . $id . '/invoice';
...
$image = imagecreatefrompng(get_template_directory() . '/invoice/image.png');
$font = get_template_directory() . '/invoice/TimesNewRomanRegular.ttf';
